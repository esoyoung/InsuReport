...
C. 실효/해지계약 현황 📋 **🚨 매우 중요 - 절대 누락 금지**
- **PDF 전체를 스캔**하여 실효/해지 관련 섹션 찾기
- 가능한 섹션 제목들:
  - "실효/해지계약", "실효·해지계약현황", "효력상실/해지 계약"
  - "해지계약", "실효계약", "계약현황" 중 실효/해지 부분
  - PDF 마지막 페이지나 계약 리스트 다음에 위치할 수 있음
- **⚠️ 참고 데이터에 실효해지계약이 있으면, PDF에도 반드시 있습니다!**
- **섹션을 찾을 수 없다면, 계약 리스트에서 '상태'가 '실효', '해지', '효력상실'인 항목 찾기**
- 섹션 정말로 없으면 빈 배열 [] 반환
