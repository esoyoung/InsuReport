...
- ⚠️ **월보험료 합계 (매우 중요 - 절대 계산 금지)**:
  - **반드시 5페이지에서 찾을 것**:
    1. 5페이지 최상단에 "보유 계약 현황" 또는 유사한 제목이 있음
    2. 그 아래에 요약 정보 박스/섹션이 있음 (테이블보다 위쪽)
    3. 요약 정보에 "계약수", "월보험료" 등의 필드가 있음
    4. **"월보험료: XXX,XXX원"** 형식으로 표시됨
  - 이 월보험료 값을 그대로 "총보험료"와 "활성월보험료"에 사용
  - 예시:
    - 강민재: 5페이지 상단 "월보험료: 153,500원" → 153500
    - 안영균: 5페이지 상단 "월보험료: 427,097원" → 427097
  - **절대 계약 리스트를 더하거나 계산하지 말 것**
...
**총보험료/활성월보험료 예시:**
- 강민재 케이스: 5페이지 상단 "월보험료: 153,500원" → 총보험료: 153500, 활성월보험료: 153500
- 안영균 케이스: 5페이지 상단 "월보험료: 427,097원" → 총보험료: 427097, 활성월보험료: 427097
- **주의**: 계약 리스트 합계가 아닌, 5페이지 상단 요약의 월보험료 사용
